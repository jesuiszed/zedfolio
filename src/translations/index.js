  ...
  en: {
    ...
    about: {
      ...
      bulletPoints: {
        ...
        ai: "🤖 AI Explorer",
        learning: "🌱 Currently learning Cloud Architecture"
      },
      buttons: {
    ...
    footer: {
      copyright: "© {year} Flo.Zed. All rights reserved.",
      socialLinks: {
        github: "GitHub",
        linkedin: "LinkedIn"
      }
  ...
  fr: {
    ...
    about: {
      ...
      bulletPoints: {
        ...
        security: "🔒 Passionné de Cybersécurité",
        ai: "🤖 Explorateur IA",
        learning: "🌱 En formation sur l'Architecture Cloud"
      },
      buttons: {
    ...
    footer: {
      copyright: "© {year} Flo.Zed. Tous droits réservés.",
      socialLinks: {
        github: "GitHub",
        linkedin: "LinkedIn"
      }
